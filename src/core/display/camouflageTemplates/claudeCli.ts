import { ANSI_DIM, ANSI_GREEN, ANSI_MAGENTA, ANSI_RESET, ANSI_YELLOW, DIFF_CYAN, DIFF_DIM, DIFF_GREEN, DIFF_RED, paint } from './ansi';
import { CLAUDE_CLI_SHORTCUT_HINT } from './keys';
