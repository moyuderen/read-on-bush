...
import type {
  ...
  TerminalTemplate
} from '../display/camouflageTemplates';
import { getPrivacyDisplayOnStart, type BookListGroupBy } from '../settings';
...
export class PrivacyDisplayService {
  ...
  getGroupDisplayName(groupName: string, groupBy: BookListGroupBy): string {
    return this.isPrivate && groupBy === 'directory' ? '本地文档' : groupName;
  }
