import type { TerminalCamouflageTemplateSettings } from '../../config/settings';
import { resolveBuiltinTemplate } from './CamouflageRenderer';
import { parseCustomTerminalTemplate } from '../readerTemplates/CustomTemplate';
...
export class CamouflageTemplateService {
  ...
  // 让 CamouflageRenderer 的 WeakMap 调试行缓存能跨翻页命中；解析失败时也作为「上一次有效」回退。
